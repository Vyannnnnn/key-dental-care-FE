...
const Navigation = () => {
  ...
  return (
    <aside className="sticky top-0 flex flex-col min-w-[300px] h-screen px-4 py-8 overflow-hidden bg-[#f8fafc] border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
